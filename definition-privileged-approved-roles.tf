locals {
  ...
  privileged_principal_types_as_string    = join(", ", [for s in var.privileged_role_restriction_policy.privileged_role_definition_restricted_principal_types : format("%q", s)])
}
